...
# Main
OWNER_ID = int(os.environ.get("OWNER_ID", "8599429441"))
...
# Messages
START_MSG = os.environ.get("START_MESSAGE", "<b>ɪ ᴀᴍ ᴀ ʜɪɢʜ-ꜱᴘᴇᴇᴅ, ꜱᴇᴄᴜʀᴇ ʙᴏᴛ ᴅᴇꜱɪɢɴᴇᴅ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ᴘʀɪᴠᴀᴛᴇ ᴀɴᴅ ꜱʜᴀʀᴇᴀʙʟᴇ ʟɪɴᴋꜱ ꜰᴏʀ ʏᴏᴜʀ ᴘʀᴇᴍɪᴜᴍ ᴄᴏɴᴛᴇɴᴛ. ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ'ꜱ ᴘʀɪᴠᴀᴄʏ ɪꜱ ᴍʏ ᴛᴏᴘ ᴘʀɪᴏʀɪᴛʏ</b></blockquote>")
...
try:
    ADMINS = []
    for x in (os.environ.get("ADMINS", "8599429441").split()):
        ADMINS.append(int(x))
except ValueError:
